1. I used a java program to produce ten random strings as the inputs,the length range is [10,100] with increment of 10.
...
5. I created a fold named String Tests to store the input documents and every encode.txt and decode.txt, by comparing with them, 
...
6. I also ploted four figures, and find that:
   ...
   b.The Time complexity of the decode function is O(n2);
   c.The Space complexity of the encode function is O(1);
   d.The Space complexity of the decode function is O(n2);
